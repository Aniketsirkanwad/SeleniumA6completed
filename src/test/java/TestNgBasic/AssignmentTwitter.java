...
public class AssignmentTwitter {
	public class Task1_FillDetilsInFacebook extends BaseClassDWS {

		@Test
		public void fillFacebookDetails() throws InterruptedException, EncryptedDocumentException, IOException
		{
